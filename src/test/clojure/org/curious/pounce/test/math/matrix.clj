...
(def test-matrix-2x1 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 2 1)
                                                               (aset-double 0 0 1)
                                                               (aset-double 1 0 2))))
(def test-matrix-2x2 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 2 2)
                                                               (aset-double 0 0 1)
                                                               (aset-double 1 0 2)
                                                               (aset-double 0 1 3)
                                                               (aset-double 1 1 4))))
(def test-matrix-2x3 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 2 3)
                                                               (aset-double 0 0 1)
                                                               (aset-double 1 0 2)
                                                               (aset-double 0 1 3)
                                                               (aset-double 1 1 4)
                                                               (aset-double 0 2 5)
                                                               (aset-double 1 2 6))))
(def test-matrix-3x2 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 3 2)
                                                               (aset-double 0 0 1)
                                                               (aset-double 1 0 2)
                                                               (aset-double 2 0 3)
                                                               (aset-double 0 1 4)
                                                               (aset-double 1 1 5)
                                                               (aset-double 2 1 6))))
(def test-matrix-3x3 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 3 3)
                                                               (aset-double 0 0 1)
                                                               (aset-double 1 0 2)
                                                               (aset-double 2 0 3)
                                                               (aset-double 0 1 4)
...
(def test-multi-matrix-2x2 (org.curious.pounce.math.matrix.MultiMatrix. 2 2 (doto (make-array org.curious.pounce.math.matrix.Matrix 2 2)
                                                                              ...
                                                                              (aset 1 0 nil)
                                                                              (aset 0 1 nil)
                                                                              (aset 1 1 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 2 2)
                                                                                                                                  (aset-double 0 0 -1)
                                                                                                                                  (aset-double 1 0 -2)
                                                                                                                                  (aset-double 0 1 -3)
                                                                                                                                  (aset-double 1 1 -4)))))))
...
(def test-rotation (org.curious.pounce.math.matrix.Matrix. (doto (make-array Double/TYPE 2 2)
                                                             (aset-double 0 0 0)
                                                             (aset-double 1 0 1)
                                                             (aset-double 0 1 -1)
                                                             (aset-double 1 1 0))))
...
(test/deftest matrix-test-1
  (test/is (= (matrix/mat test-matrix-2x1) test-matrix-2x1)))
(test/deftest matrix-test-2
  (test/is (= (matrix/column 1 2) test-matrix-2x1)))
...
(test/deftest transformation-test-2
  (test/is (= (matrix/transformation (matrix/column 1 2) (/ math/pi 2)) test-transformation)))
...
(test/deftest rotate-test
  (test/is (= (matrix/rotate test-matrix-2x1 (/ math/pi 2)) (matrix/column -2 1))))
(test/deftest transform-test
  (test/is (= (matrix/transform test-matrix-2x1 test-transformation) (matrix/column -1 3))))
(test/deftest gauss-seidel-test
  (test/is (= (matrix/gauss-seidel (matrix/create [16 7] [3 -11]) (matrix/column 11 13) 100) (matrix/column 0.8121827411157131 -0.6649746192900007)))
  (test/is (= (matrix/gauss-seidel (matrix/create [16 7] [3 -11]) (matrix/column 11 13) math/eps) (matrix/column 0.8121827411157131 -0.6649746192900007))))
