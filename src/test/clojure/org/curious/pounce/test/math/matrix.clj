...
(def test-matrix-2x1 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 2 1)
                                                               (aset-float 0 0 1)
                                                               (aset-float 1 0 2))))
(def test-matrix-2x2 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 2 2)
                                                               (aset-float 0 0 1)
                                                               (aset-float 1 0 2)
                                                               (aset-float 0 1 3)
                                                               (aset-float 1 1 4))))
(def test-matrix-2x3 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 2 3)
                                                               (aset-float 0 0 1)
                                                               (aset-float 1 0 2)
                                                               (aset-float 0 1 3)
                                                               (aset-float 1 1 4)
                                                               (aset-float 0 2 5)
                                                               (aset-float 1 2 6))))
(def test-matrix-3x2 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 3 2)
                                                               (aset-float 0 0 1)
                                                               (aset-float 1 0 2)
                                                               (aset-float 2 0 3)
                                                               (aset-float 0 1 4)
                                                               (aset-float 1 1 5)
                                                               (aset-float 2 1 6))))
(def test-matrix-3x3 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 3 3)
                                                               (aset-float 0 0 1)
                                                               (aset-float 1 0 2)
                                                               (aset-float 2 0 3)
                                                               (aset-float 0 1 4)
...
(def test-multi-matrix-2x2 (org.curious.pounce.math.matrix.MultiMatrix. 2 2 (doto (make-array org.curious.pounce.math.matrix.Matrix 2 2)
                                                                              ...
                                                                              (aset 1 0 nil)
                                                                              (aset 0 1 nil)
                                                                              (aset 1 1 (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 2 2)
                                                                                                                                  (aset-float 0 0 -1)
                                                                                                                                  (aset-float 1 0 -2)
                                                                                                                                  (aset-float 0 1 -3)
                                                                                                                                  (aset-float 1 1 -4)))))))
...
(def test-rotation (org.curious.pounce.math.matrix.Matrix. (doto (make-array Float/TYPE 2 2)
                                                             (aset-float 0 0 0)
                                                             (aset-float 1 0 1)
                                                             (aset-float 0 1 -1)
                                                             (aset-float 1 1 0))))
...
(test/deftest gauss-seidel-test
  (test/is (= (matrix/gauss-seidel (matrix/create [16 7] [3 -11]) (matrix/create 11 13) 10) (matrix/create 0.8121827 -0.66497463)))
  (test/is (= (matrix/gauss-seidel (matrix/create [16 7] [3 -11]) (matrix/create 11 13) math/eps) (matrix/create 0.8121827 -0.66497463))))
